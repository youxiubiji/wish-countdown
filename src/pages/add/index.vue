    ...
    <view class="content">
        <view class="list">
            <view class="uni-form-item">
                ...
                <input class="uni-input" focus v-model="title" placeholder-style="color: #999;font-size: 30rpx" placeholder="如：高考、项目、纪念日、家人生日等" />
            </view>
            <view class="uni-form-item">
                <view class="title">倒计时日期</view>
                <picker :value="date" mode="date" :start="startDate" :end="endDate" @change="bindDateChange">
                    <input class="uni-input" :disabled="true" v-model="date" placeholder-style="color: #999;font-size: 30rpx" placeholder="请选择倒计时日期" />
                </picker>
            </view>
        </view>
        <view class="btn-auto">
